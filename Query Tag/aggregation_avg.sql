...
from sqlt_data_1_2020_01
group by dateadd(minute, (datediff(minute, 0, dateadd(s, convert(bigint, t_stamp)/1000, convert(datetime, '1-1-1970 00:00:00'))) / @Interval) * @Interval, 0)
